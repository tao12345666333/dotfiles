--[[
     ...
     base on Luca CPZ's https://github.com/lcpz/awesome-copycats
...
-- Note:
-- I only used the powerarrow theme
...
globalkeys = mytable.join(
    ...
    -- screenshot
    awful.key({ modkey,           }, "s",      function () awful.util.spawn_with_shell("sleep 0.5 && gnome-screenshot -a") end),
