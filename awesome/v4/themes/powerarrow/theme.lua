...
theme.taglist_fg_focus                          = "#EA6F81"
theme.tasklist_bg_focus                         = "#222222"
theme.tasklist_fg_focus                         = "#EA6F81"
...
local net = lain.widget.net({
    settings = function()
        widget:set_markup(markup.fontfg(theme.font, "#FEFEFE", " " .. string.format("%06.1f", net_now.received) .. " ↓↑ " .. string.format("%06.1f", net_now.sent) .. " "))
    end
})
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            arrow("#4B3B51", "#CB755B"),
            wibox.container.background(wibox.container.margin(wibox.widget { volicon, theme.volume.widget, layout = wibox.layout.align.horizontal }, dpi(4), dpi(4)), "#CB755B"),
            arrow("#CB755B", "#8DAA9A"),
            ...
            arrow("#8DAA9A", "#4B3B51"),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, nil, clock, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#4B3B51"),
            arrow("#4B3B51", "#777E76"),
